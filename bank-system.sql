...
CREATE TABLE account_type (
    id INT AUTO_INCREMENT PRIMARY KEY,  -- Usamos o tipo INT aqui também
...
CREATE TABLE bank_client (
    id INT AUTO_INCREMENT PRIMARY KEY,  -- Aqui usamos INT para garantir compatibilidade
...
CREATE TABLE bank_account (
    id INT AUTO_INCREMENT PRIMARY KEY,  -- Usando INT para garantir compatibilidade
...
INSERT INTO bank_client (name, cpf, phone, birthdate) 
VALUES ('João Silva', '123.456.789-00', '11987654321', '1990-05-15');

INSERT INTO bank_client (name, cpf, phone, birthdate) 
VALUES ('Maria Oliveira', '987.654.321-00', '11876543210', '1985-09-22');
